import type { DailyReportSalesDetail } from "@/lib/types/daily-report";
import {
  Table,
  TableBody,
  TableCell,
...
interface DailySalesDetailTableProps {
  data: DailyReportSalesDetail[];
  isLoading: boolean;
}

/**
 * Sales detail matrix table for daily report.
 * Dynamic columns built from the `categories` map across all sales rows.
 * Shows each sales' qty per product category + total qty.
 */
export function DailySalesDetailTable({ data, isLoading }: DailySalesDetailTableProps) {
        ...
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <CardDescription className="mt-0.5">
              Rincian pencapaian sales hari ini per kategori produk
            </CardDescription>
          </div>
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span>Belum ada data sales untuk hari ini.</span>
                  </div>
                </TableCell>
              </TableRow>
            )}
