import type { POSummaryTrendPoint } from "@/lib/types/po-summary";
...
interface POSummaryTrendChartProps {
  data: POSummaryTrendPoint[];
  startDate?: string;
  endDate?: string;
  isLoading: boolean;
}
...
/** Formats YYYY-MM-DD → short label, e.g. "1 Jul" */
...
/**
 * Area chart showing daily order quantity trends for a specific PO period.
 * Displays data from start_date to end_date of the Batch PO.
 */
export function POSummaryTrendChart({ data, startDate, endDate, isLoading }: POSummaryTrendChartProps) {
        ...
        <div className="flex items-start justify-between gap-2">
          <div>
            <CardTitle className="text-base flex items-center gap-2">
              ...
              Tren Order Harian — PO
            </CardTitle>
            <CardDescription className="mt-0.5">
              Grafik kuantitas pesanan harian selama periode PO
            </CardDescription>
            {hasDateRange && (
        ...
        {chartData.length > 0 ? (
          <ChartContainer config={chartConfig} className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                <defs>
                  <linearGradient id="poTrendGradient" x1="0" y1="0" x2="0" y2="1">
